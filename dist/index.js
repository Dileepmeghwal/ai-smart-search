...
var SmartUIContext = react.createContext(__spreadProps(__spreadValues({}, defaultConfig), {
  resolvedTheme: {}
}));
function SmartUIProvider({
  ...
  const merged = react.useMemo(() => __spreadValues(__spreadValues({}, defaultConfig), config), [config]);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(SmartUIContext.Provider, { value: __spreadProps(__spreadValues({}, merged), { resolvedTheme }), children: /* @__PURE__ */ jsxRuntime.jsx("div", { style: resolvedTheme, children }) });
}
function useSmartUIConfig() {
  return react.useContext(SmartUIContext);
}
...
function SmartSearch({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: `w-full max-w-2xl mx-auto ${className}`, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `relative group ${containerClassName}`, children: [
    /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        className: `relative flex items-center bg-white dark:bg-slate-900
            ...
            ${inputWrapperClassName}`,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mr-4 text-slate-400 group-focus-within:text-primary transition-colors shrink-0", children: loading ? /* @__PURE__ */ jsxRuntime.jsx(
            lucideReact.Loader2,
            {
              className: "w-5 h-5 animate-spin text-primary",
              "aria-hidden": "true"
            }
          ) : /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Search, { className: "w-5 h-5", "aria-hidden": "true" }) }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative flex-1 h-8 flex items-center overflow-hidden", children: [
            showGhost && /* @__PURE__ */ jsxRuntime.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntime.jsx("span", { className: "opacity-0", children: query }),
            ...
            showCorrection && /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                className: `absolute left-0 inset-y-0 pointer-events-none text-lg font-medium
                  select-none flex items-center whitespace-pre z-0 ${ghostTextClassName}`,
                "aria-hidden": "true",
                children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-primary/40 italic", children: suggestion })
              }
            ),
            /* @__PURE__ */ jsxRuntime.jsx(
              "input",
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(
                ...
                ${badgeClassName}`,
                  children: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Zap, { className: "w-3.5 h-3.5" })
                }
              )
            }
          )
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          ...
          showIntelligence && hasFilters && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-1.5", children: [
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntime.jsx(lucideReact.SlidersHorizontal, { className: "w-3 h-3 text-slate-400" }),
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-[10px] font-bold text-slate-400 uppercase tracking-widest", children: "Converted filters" })
            ] }),
            /* @__PURE__ */ jsxRuntime.jsx("ul", { role: "list", className: "flex flex-wrap gap-2", children: Object.entries(activeFilters).map(([key, value]) => /* @__PURE__ */ jsxRuntime.jsxs(
              "li",
              {
                className: "flex items-center gap-1.5 bg-primary/10 text-primary\n                      pl-2.5 pr-1.5 py-1 rounded-full text-xs font-medium",
                children: [
                  /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "text-primary/50 font-normal", children: [
                    key,
                    ":"
                  ] }),
                  /* @__PURE__ */ jsxRuntime.jsx("span", { children: String(value) }),
                  /* @__PURE__ */ jsxRuntime.jsx(
                    "button",
                    {
          ...
          showIntelligence && showRelated && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-1.5", children: [
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntime.jsx(lucideReact.CornerDownRight, { className: "w-3 h-3 text-slate-400" }),
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-[10px] font-bold text-slate-400 uppercase tracking-widest", children: "Related searches" })
            ] }),
            /* @__PURE__ */ jsxRuntime.jsx("ul", { role: "list", className: "flex flex-wrap gap-2", children: related.map((term, i) => /* @__PURE__ */ jsxRuntime.jsx("li", { children: /* @__PURE__ */ jsxRuntime.jsx(
              "button",
              {
          ...
          showTrending && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-1.5", children: [
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntime.jsx(lucideReact.TrendingUp, { className: "w-3 h-3 text-slate-400" }),
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-[10px] font-bold text-slate-400 uppercase tracking-widest", children: "Trending searches" })
            ] }),
            /* @__PURE__ */ jsxRuntime.jsx("ul", { role: "list", className: "flex flex-wrap gap-2", children: trendingItems.map((term, i) => /* @__PURE__ */ jsxRuntime.jsx("li", { children: /* @__PURE__ */ jsxRuntime.jsx(
              "button",
              {
                onClick: () => applyQuery(term),
                className: "text-xs font-medium px-2.5 py-1 rounded-full\n                        bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300\n                        hover:bg-primary/10 hover:text-primary transition-colors",
...
var SmartFormField = react.forwardRef(
  function SmartFormField2(_a, forwardedRef) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `relative flex flex-col gap-1 ${containerClassName}`, children: [
      /* @__PURE__ */ jsxRuntime.jsxs(
        "label",
        {
          id: labelId,
          ...
          children: [
            ...
            showBadge && /* @__PURE__ */ jsxRuntime.jsxs(
              "span",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Sparkles, { className: "w-2.5 h-2.5", "aria-hidden": "true" }),
                  "AI"
                ]
              }
            )
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "pr-3 flex items-center gap-1.5 shrink-0", "aria-hidden": "true", children: loading ? /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Loader2, { className: "w-4 h-4 animate-spin text-primary" }) : suggestions.length > 0 ? /* @__PURE__ */ jsxRuntime.jsx(
              lucideReact.ChevronDown,
              {
                className: `w-4 h-4 text-slate-400 transition-transform ${isOpen ? "rotate-180" : ""}`
              }
            ) : /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Sparkles, { className: "w-4 h-4 text-slate-300" }) })
          ]
        }
      ),
      isOpen && suggestions.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(
        "ul",
        __spreadProps(__spreadValues({}, listProps), {
          ...
          children: suggestions.map((s, i) => /* @__PURE__ */ jsxRuntime.jsxs(
            "li",
            __spreadProps(__spreadValues({}, getItemProps(i)), {
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsx("span", { children: s.value }),
                s.confidence >= 0.9 && /* @__PURE__ */ jsxRuntime.jsx(
...
exports.SmartFormField = SmartFormField;
exports.SmartSearch = SmartSearch;
exports.SmartUIProvider = SmartUIProvider;
exports.useAISuggestion = useAISuggestion;
exports.useSmartFormAutofill = useSmartFormAutofill;
exports.useSmartUIConfig = useSmartUIConfig;
